...
function displayIcon(stamp, code) {
  ...
  switch (code) {
    ...
    case '803' || '804':
      ...
      break;
    case '800' && (nigthmode === true):
      icon = 'url(icons/clearN.png)';
      break;
    case '801' && (nigthmode === true):
      icon = 'url(icons/few_cloudsN.png)';
      break;
    case '802' && (nigthmode === true):
      icon = 'url(icons/cloudsN.png)';
      break;
    case ('803' || '804') && (nigthmode === true):
      icon = 'url(icons/broken_cloudsN.png)';
      break;
    case '701' || '711' || '721':
